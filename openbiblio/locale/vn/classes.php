...
$trans["Amount must be greater than zero."] = "\$text = 'Số tiền phải lớn hơn không.';";
...
#****************************************************************************
#*  Dịch vụ văn bản cho lớp CircQuery
#****************************************************************************
$trans["Can't understand date: %err%"] = "\$text = 'Không thể hiểu ngày: %err%';";
$trans["Won't do checkouts for future dates."] = "\$text = 'Không thực hiện mượn sách cho các ngày tương lai.';";
$trans["Bad member barcode: %bcode%"] = "\$text = 'Mã vạch thành viên không hợp lệ: %bcode%';";
$trans["Member owes fines: checkout not allowed"] = "\$text = 'Thành viên nợ phạt: không được phép mượn sách';";
$trans["Member must renew membership before checking out."] = "\$text = 'Thành viên phải gia hạn thẻ trước khi mượn sách.';";
$trans["Bad copy barcode: %bcode%"] = "\$text = 'Mã vạch sách không hợp lệ: %bcode%';";
$trans["Item %bcode% has reached its renewal limit."] = "\$text = 'Sách %bcode% đã đạt đến giới hạn gia hạn.';";
$trans["Item %bcode% is late and cannot be renewed."] = "\$text = 'Sách %bcode% đang trễ và không thể gia hạn.';";
$trans["Item %bcode% is on hold."] = "\$text = 'Sách %bcode% đang bị giữ.';";
$trans["Item %bcode% is already checked out to another member."] = "\$text = 'Sách %bcode% đã được mượn bởi thành viên khác.';";
$trans["Item %bcode% isn't out and cannot be renewed."] = "\$text = 'Sách %bcode% không được mượn và không thể gia hạn.';";
$trans["Member has reached checkout limit for this collection."] = "\$text = 'Thành viên đã đạt đến giới hạn mượn sách cho bộ sưu tập này.';";
$trans["Checkouts are disallowed for this collection."] = "\$text = 'Không được phép mượn sách trong bộ sưu tập này.';";
$trans["Item is on hold for another member."] = "\$text = 'Sách đang được giữ cho thành viên khác.';";
$trans["!!!Note : due date is after the end of the membership"] = "\$text = '!!!Lưu ý : ngày đến hạn sau ngày kết thúc thẻ thành viên';";
$trans["Can't change status to an earlier date on item %bcode%."] = "\$text = 'Không thể thay đổi trạng thái thành ngày trước trên sách %bcode%.';";
$trans["Can't change status more than once per second on item %bcode%."] = "\$text = 'Không thể thay đổi trạng thái hơn một lần mỗi giây trên sách %bcode%.';";
$trans["Won't do checkins for future dates."] = "\$text = 'Không thực hiện trả sách cho các ngày tương lai.';";
$trans["Late fee (barcode=%barcode%)"] = "\$text = 'Phí trễ hạn (mã vạch=%barcode%)';";
