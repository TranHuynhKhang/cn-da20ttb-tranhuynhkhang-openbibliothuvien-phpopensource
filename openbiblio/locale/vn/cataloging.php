...
#****************************************************************************
#*  Dịch văn bản cho trang biblio_history.php
#****************************************************************************
$trans["Bibliography Checkout History:"] = "\$text = 'Lịch sử Mượn Sách:';";
$trans["Date"] = "\$text = 'Ngày';";
$trans["Barcode"] = "\$text = 'Mã vạch';";
$trans["New Status"] = "\$text = 'Tình trạng mới';";
$trans["Member"] = "\$text = 'Thành viên';";
$trans["Due Date"] = "\$text = 'Ngày đến hạn';";
$trans["No history was found."] = "\$text = 'Không tìm thấy lịch sử.';";
